...
abstract class ViewModelFactoryModule {
    ...
    abstract fun bindsCreateSafeConfirmSetupRecoveryPhraseContract(viewModel: CreateSafeConfirmRecoveryPhraseViewModel): ViewModel
    ...
    abstract fun bindsNewConfirmRecoveryPhraseContract(viewModel: ConfirmNewRecoveryPhraseViewModel): ViewModel
