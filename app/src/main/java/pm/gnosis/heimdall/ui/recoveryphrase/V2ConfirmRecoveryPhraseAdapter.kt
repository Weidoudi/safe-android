...
@ForView
class V2ConfirmRecoveryPhraseAdapter @Inject constructor() : RecyclerView.Adapter<V2ConfirmRecoveryPhraseAdapter.ViewHolder>() {
    ...
    fun observeSelectedCount(): Observable<Int> = selectedWordCountSubject
