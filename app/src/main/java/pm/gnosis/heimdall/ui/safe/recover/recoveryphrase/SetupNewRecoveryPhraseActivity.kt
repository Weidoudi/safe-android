...
class SetupNewRecoveryPhraseActivity : SetupRecoveryPhraseActivity<SetupRecoveryPhraseContract>() {
    ...
    override fun onConfirmedRecoveryPhrase(encryptedRecoveryPhrase: String) {
        startActivity(ConfirmNewRecoveryPhraseActivity.createIntent(this, safeAddress, browserAddress, encryptedRecoveryPhrase))
    }
